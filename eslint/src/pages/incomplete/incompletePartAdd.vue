<template>
  <div>
    <h2 class="bread-crumb">{{title}} Part No.</h2>
    <div class="formbox">
      <el-form :model="form" size="small" onsubmit="return false;">
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="Part No.:">
              <el-input class="industry-inp" v-model="form.PartNo" :disabled="queryIndex==1" placeholder=""></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="Part Name:">
              <el-input class="industry-inp" v-model="form.PartName" placeholder=""></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <el-form-item label="Material:">
              <el-select v-model="form.MaterialID" class="w100" placeholder="" @change="changeMaterial">
          ...
          <el-col :span="8">
            <el-form-item label="Function:">
              <el-select v-model="form.FunctionID" class="w100" placeholder="" @change="changeFunction">
          ...
          <el-col :span="8">
            <el-form-item label="Installation:">
              <el-select v-model="form.InstallationID" class="w100" placeholder="" @change="changeInstallation">
        ...
        <el-row>
          <el-col :span="16">
            <el-form-item label="Description:">
              <el-input class="industry-inp" type="textarea" v-model="form.Description" placeholder=""
                        :rows="5"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
            ...
            <el-table :data="tableData2" border stripe size="small" style="width: 100%">
              <el-table-column width="50" align="center" label=" ">
                <template slot-scope="scope">
                  <el-radio v-model="radio" @change="radioChange" :label="scope.row" class="radio-box">&nbsp;</el-radio>
                </template>
              </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeInstallation(val) {
        this.form.InstallationName = '';
        this.radio = null;
      },
      /*================== 查询 ==================*/
      searchInner(e){
      ...
      radioChange(row){
        ...
        this.form.InstallationID = row.InstallationID;
        //console.log(row)
      },
      /*================== Cancel ==================*/
      handelCancel() {
      ...
      handelSave() {
        ...
        // 编辑时的保存
        if (this.queryIndex == 1) {
          partNoUpdate(this.form).then((res) => {
            if (res.data[0].MessageCode == ERR_OK) {
              this.handelCancel();
              this.$message({
                type: 'success',
