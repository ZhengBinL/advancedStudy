  ...
  <div class="table-box">
    ...
    <div class="table-set">
      ...
      <el-table :data="tableData" border stripe size="small" style="width: 100%">
        ...
        <el-table-column label="Action" width="240" show-overflow-tooltip>
          <template slot-scope="scope">
            ...
            <el-button @click="handleDelete(scope.row.PartID)" type="danger" size="mini">Delete</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
<script>
  ...
  import { partNoList, partNoDel } from "@/axios/partNo.js";
  ...
  export default {
    ...
    methods: {
      ...
      /*================== 添加 ==================*/
      goAdd(){
        this.$router.push({name:'incompletePartAdd'})
      },
      /*================== View ==================*/
      handleView(data){
        this.$router.push({
